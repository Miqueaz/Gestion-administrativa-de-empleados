...
class Empleados(models.Model):
    numero = models.AutoField(primary_key=True)
    usuario = models.ForeignKey(User, models.DO_NOTHING, db_column='Usuario', blank=True, null=True)  # Field name made lowercase.
...
class Metas(models.Model):
    numero = models.AutoField(primary_key=True)
    meta = models.CharField(db_column='Meta', max_length=150)  # Field name made lowercase.
    fechainicio = models.DateField(db_column='FechaInicio')  # Field name made lowercase.
